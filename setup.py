...
setup(
  ...
  description = 'Do geometric computations on dark matter particle data',   # Give a short description about your library
  author = 'Lorena Mezini',                   # Type in your name
  author_email = 'lom31@pitt.edu',      # Type in your E-Mail
  url = 'https://github.com/user/reponame',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/user/reponame/archive/v_01.tar.gz',    # I explain this later on
  keywords = ['simulation', 'dark matter', 'geometry'],   # Keywords that define your package best
